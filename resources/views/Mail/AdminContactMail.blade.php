            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <span class="preheader"
                        style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Thank
                        you so much for taking the time to visit my portfolio and for using the
                        contact form to get in touch with me..</span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <h3
                                    style="font-family: Helvetica,font-weight:bod; sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    New Contact Form Message</h3>
                                <p
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Oghenekevwe Joshua <br>Fullstack Web Developer <br> <a
                                        href="https://kevwe-joshua.tech/">kevwe-joshua.tech</a> </p>
                            </td>
                        </tr>
